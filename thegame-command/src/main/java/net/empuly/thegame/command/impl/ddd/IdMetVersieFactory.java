...
public class IdMetVersieFactory {
	...
	public IdMetVersie initieleVersieMetRandomId() {
		return initieleVersieMetId(UUID.randomUUID());
	}
	...
	public IdMetVersie specifiekeVersieVanSpecifiekeId(final UUID id, final long version) {
		checkNotNull(id);
		checkArgument(version >= IdMetVersie.INITIELE_VERSIE, "Versie moet groter zijn dan initiele versie: " + IdMetVersie.INITIELE_VERSIE + " maar was " + version);
